 ...
 * by by Robert Sedgewick and Kevin Wayne
 */
...
public class Graph {
     ...
     *
     * @param name a String name of a Vertex that may be in this Graph
    ...
    /**
     * Sets each Vertices' centrality field to the degree of each Vertex (i.e.
    ...
    /**
     * Sets each Vertices' centrality field to the average distance to every
     * Vertex
     */
    ...
    /**
     * Sets each Vertices' centrality field to the proportion of geodesics
     * (shortest paths) that this Vertex is on
     */
